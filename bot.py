...
bot = telebot.TeleBot("7610862594:AAFn4nk-4taH0pswZwjbk6j9GS_WHrGA-6g")
...
def get_ping(proxy_url):
    try:
        ...
        response = subprocess.run(["ping", "-c", "1", proxy_ip], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        end_time = time.time()
